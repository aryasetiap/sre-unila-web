...
const AboutSection = () => {
    return (
        <section className="bg-emerald-50 text-gray-800 py-16 px-6 md:px-20">
            {/* Header Gradient */}
            ...
            {/* About SRE Unila */}
            <div className="mt-10 mb-16 md:flex md:items-start md:justify-between">
                <div className="mb-6 md:mb-0">
                    <h2 className="text-[#0F926C] text-4xl font-extrabold">
                        ABOUT <br />
                        <span className="text-4xl font-extrabold">SRE UNILA</span>
                    </h2>
                    <div className="w-64 h-2 bg-gradient-to-r from-[#0F926C] to-[#ffffff] mt-2 rounded-full"></div>
                </div>
