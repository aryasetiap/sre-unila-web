...
const agendaDay1 = [
  ["07:30 - 08:40", "Opening Ceremony"],
  ["08:55 - 09:10", "Keynote Speech: Make Cities and Human Settlements Inclusive, Safe, and Sustainable."],
  ["09:10 - 10:05", "Panel Session 1: Living in the Threat of Natural Hazards - Can Disasters and Sustainable Development Go Together?"],
    ...
    <>
      ...
      <section id="after-hero-section" className="bg-white py-12 px-4 md:px-12 space-y-12">
        ...
        <ExpandableCardEsf
          ...
          location="Grand Krakatau Ballroom, Swiss-Belhotel Lampung"
          agendaList={[
            ["08.30 - 09.35", "Opening & Event Reporting"],
            ["09.35 - 11.35", "Presentation of Thematic Meeting Results (Per Meeting Room)"],
